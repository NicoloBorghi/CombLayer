...
simplebeamTube::simplebeamTube(const std::string& Key) :
...
simplebeamTube::simplebeamTube(const simplebeamTube& A) : 
  ...
  /*!
    Copy constructor
    \param A :: simplebeamTube to copy
  */
{}

simplebeamTube&
simplebeamTube::operator=(const simplebeamTube& A)
  /*!
    Assignment operator
    \param A :: simplebeamTube to copy
    \return *this
...
void
simplebeamTube::populate(const FuncDataBase& Control)
  /*!
    Populate all the variables
    \param Control :: Variable table to use
  */
{
  ELog::RegMethod RegA("simplebeamTube","populate");
...
void
simplebeamTube::createUnitVector(const attachSystem::FixedComp& FC,const long sideIndex)
  /*!
    Create the unit vectors
    \param FC :: Fixed Component
  */
{
  ELog::RegMethod RegA("simplebeamTube","createUnitVector");
...
void
simplebeamTube::createSurfaces(const long sideIndex,const attachSystem::FixedComp& FC)
  /*!
    Create planes for system
  */
{
  ELog::RegMethod RegA("simplebeamTube","createSurfaces");
...
void
simplebeamTube::createObjects(Simulation& System,const long sideIndex,const attachSystem::FixedComp& FC)
  /*!
    Create the vaned moderator
    \param System :: Simulation to add results
  */
{
  ELog::RegMethod RegA("simplebeamTube","createObjects");
...
simplebeamTube::createLinks()
  ...
  */
{  
  ELog::RegMethod RegA("simplebeamTube","createLinks");
...
void 
simplebeamTube::layerProcess(Simulation& System)
  /*!
    Processes the splitting of the surfaces into a multilayer system
    \param System :: Simulation to work on
  */
{
  ELog::RegMethod RegA("simplebeamTube","layerProcess");
  // Steel layers
  if (nLayers>1)
    {
...
void
simplebeamTube::createAll(Simulation& System,
   ...
   */
{
  ELog::RegMethod RegA("simplebeamTube","createAll");
