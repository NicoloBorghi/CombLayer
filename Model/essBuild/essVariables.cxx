...
// -----------
  ...
  Control.addVariable("TopAFlightAngleZTop", 0);  // Step down angle !!! 1.455 is too much - fight line cuts the Bilbao target wheel ESS-0032315.3
  Control.addVariable("TopAFlightAngleZBase", 0); // Step up angle ESS-0032315.3
