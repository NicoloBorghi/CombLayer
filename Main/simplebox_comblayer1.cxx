...
main(int argc,char* argv[])
{
  ...
  setVariable:: simplebox_comblayer1Variables(SimPtr->getDataBase());
  ...
  try
    {
      ...
      simplebox_comblayer1System::makeSimplebox_comblayer1 simplebox_comblayer1Obj;
      World::createOuterObjects(*SimPtr);
      simplebox_comblayer1Obj.build(SimPtr,IParam);
